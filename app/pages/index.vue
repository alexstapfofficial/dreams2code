...
<template>
  ...
  >
    ...
    <UPageHero
      ...
      :ui="{ container: 'md:pt-18 lg:pt-20 h-screen lg:h-full' }"
    >
      <template #title>
        <div
          class="transition-opacity duration-6000 ease-out"
      ...
      <template #description>
        <div
        ref="heroTitleRef" v-show="visible">
      ...
      <img
        ...
        alt="Dreams2Code"
        class="absolute left-0 bottom-0 object-contain h-1/3 md:h-2/3 w-auto sm:max-w-sm opacity-70"
        loading="lazy"/>
    </UPageHero>
